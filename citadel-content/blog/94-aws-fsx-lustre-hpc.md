# AWS FSx for Lustre with Terraform: HPC File Systems

**Pillar:** AWS Infrastructure
**SEO Target:** aws fsx lustre terraform hpc high performance computing parallel file system
**Word Count:** ~1200

FSx for Lustre provides sub-millisecond latency parallel file systems for HPC workloads. Integrates with S3 for data repositories — perfect for ML training.

## Overview

This guide provides production-grade Terraform configurations and architectural patterns for aws fsx for lustre with terraform: hpc file systems. Each configuration follows cloud provider best practices and security benchmarks.
