# Crossplane: Kubernetes-Native Infrastructure with Terraform

**Pillar:** Multi-Cloud Architecture
**SEO Target:** crossplane kubernetes infrastructure terraform aws azure gcp composite resources
**Word Count:** ~1200

Crossplane extends Kubernetes to provision cloud infrastructure. Define AWS RDS, Azure AKS, and GCP Cloud Run as Kubernetes custom resources.

## Overview

This guide provides production-grade Terraform configurations and architectural patterns for crossplane: kubernetes-native infrastructure with terraform. Each configuration follows cloud provider best practices and security benchmarks.
