# GCP Workload Identity Federation: Keyless Auth with Terraform

**Pillar:** GCP Infrastructure
**SEO Target:** gcp workload identity federation terraform github actions aws azure keyless
**Word Count:** ~1200

Workload Identity Federation lets external identities (GitHub Actions, AWS, Azure) authenticate to GCP without service account keys — zero static credentials.

## Overview

This guide provides production-grade Terraform configurations and architectural patterns for gcp workload identity federation: keyless auth with terraform. Each configuration follows cloud provider best practices and security benchmarks.
