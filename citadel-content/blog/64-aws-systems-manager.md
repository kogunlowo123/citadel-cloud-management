# AWS Systems Manager with Terraform: Fleet Management at Scale

**Pillar:** AWS Infrastructure
**SEO Target:** aws systems manager terraform patch management session manager parameter store
**Word Count:** ~1200

Systems Manager manages EC2 fleets at scale: patch baselines, session manager (no SSH), run commands, and Parameter Store for configuration.

## Overview

This guide provides production-grade Terraform configurations and architectural patterns for aws systems manager with terraform: fleet management at scale. Each configuration follows cloud provider best practices and security benchmarks.
